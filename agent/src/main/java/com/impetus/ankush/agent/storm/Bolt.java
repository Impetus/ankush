...
public class Bolt extends BaseComponent {
	...
	public String toString() {
		return "Bolt [executeLatency=" + executeLatency + ", processLatency="
				...
				+ capacity + ", getExecuted()=" + getExecuted()
				+ ", getCapacity()=" + getCapacity() + ", getExecuteLatency()="
				+ getExecuteLatency() + ", getProcessLatency()="
				+ getProcessLatency() + ", getId()=" + getId()
				+ ", getNumberOfExecutors()=" + getNumberOfExecutors()
				+ ", getNumberOfTasks()=" + getNumberOfTasks()
				+ ", getEmitted()=" + getEmitted() + ", getTransferred()="
				+ getTransferred() + ", getAcked()=" + getAcked()
				+ ", getFailed()=" + getFailed() + ", getLastError()="
				+ getLastError() + ", getParallelism()=" + getParallelism()
