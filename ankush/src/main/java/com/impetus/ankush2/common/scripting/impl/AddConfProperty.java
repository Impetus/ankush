...
public class AddConfProperty extends AnkushTask {
	 ...
	 *            the file path
	 */
	public AddConfProperty(String name, String value, String filePath,
			String typeOfFile) {
		this.name = name;
		this.value = value;
	...
	public String getCommand() {
		...
		// + Constant.File_Extension.CONFIG + " " + this.typeOfFile + " ";
		// String startCommand = AgentUtils.getAgentBuildCommand(agentHomeDir)
		// + Constant.File_Extension.CONFIG + " " + this.typeOfFile + " ";
		...
		sb.append(Constant.File_Extension.CONFIG).append(" ")
				.append(this.typeOfFile).append(" ").append("add ")
				.append("\"" + name + "\"").append(" ")
				.append("\"" + value + "\" ").append(filePath);
		return sb.toString();
