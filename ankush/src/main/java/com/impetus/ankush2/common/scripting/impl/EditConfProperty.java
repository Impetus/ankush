...
public class EditConfProperty extends AnkushTask {
	 ...
	 *            the file path
	 */
	public EditConfProperty(String propertyName, String newValue,
			String filePath, String typeOfFile) {
	...
	public EditConfProperty(String propertyName, String newValue,
			String filePath, String typeOfFile, String agentInstallDir) {
		this.propertyName = propertyName;
		this.newValue = newValue;
		this.filePath = filePath;
		this.typeOfFile = typeOfFile;
