...
@Controller
@RequestMapping("/storm-cluster")
public class AnkushStormClusterCreation extends AbstractController {
	private static final Logger logger = LoggerFactory
	.getLogger(AnkushStormClusterCreation.class);
	
	private ArrayList<String> cssFiles;
	private ArrayList<String> jsFiles;
	public AnkushStormClusterCreation() {
	...
	public String oNodeDetail(ModelMap model) {
		...
		model.addAttribute("title", "oNodeDetail");
		return "storm/stormClusterCreation/retrievedNodeDetail";
	}
