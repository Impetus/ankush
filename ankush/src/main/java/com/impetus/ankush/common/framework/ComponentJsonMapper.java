 ...
 *
 */
public interface ComponentJsonMapper {

	GenericConfiguration createComponentConfig(RegisterClusterConf regClusterConf) throws RegisterClusterException, Exception;
