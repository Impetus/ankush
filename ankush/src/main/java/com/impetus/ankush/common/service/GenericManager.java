...
public interface GenericManager<T, PK extends Serializable> {
    ...
    /**
     * Generic method to get an object based on class and identifier. It doesn't throw any RuntimeException 
     ...
     */
    List<T> getAllByPropertyValue(Map<String, Object> propertyValueMap, String... orderBy);
    ...
    /**
     * Generic method to return an objects that satisfy the given property value condition.
     * 
     * @param property
    ...
    /**
     * Generic method to return all objects that satisfy the given property value condition.
     * 
     * @param property
     *            name of the property
     * @param value
     ...
     */
    List<T> getAllByPropertyValue(String property, Object value, String... orderBy);
     ...
     */
    List<T> getAllByPropertyValue(String property, Object value, int start, int maxResults, String... orderBy);

    /**
     * Generic method to get count of all objects that satisfy the given property value condition.
     * 
     * @param property
     *            name of the property
     * @param value
     ...
     * @param propertyValueMap the property value map
     * @return all object returned by the given named query
     */
    List<T> getAllByNamedQuery(String queryName, Map<String, Object> propertyValueMap);
     ...
     * @return all objects that match the criteria
     */
    List<T> getAllByDisjunctionveNormalQuery(List<Map<String, Object>> disjunctionMaps, String... orderBy);
    ...
    /**
     * Generic method to delete all objects that satisfy the given property/value.
     * 
     * @param property
     *            name of the property
     * @param value
