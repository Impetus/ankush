...
public class DeleteConfProperty extends AnkushTask {
	 ...
	 */
	public DeleteConfProperty(String propertyName, String filePath,String typeOfFile) {
	...
	public String getCommand() {
		String deletePropCommand = "java -cp $HOME/.ankush/agent/libs/*:$HOME/.ankush/agent/libs/agent-0.1.jar"
