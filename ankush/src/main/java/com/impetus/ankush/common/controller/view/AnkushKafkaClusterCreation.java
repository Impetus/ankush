...
public class AnkushKafkaClusterCreation extends AbstractController {
	private static final Logger logger = LoggerFactory
	.getLogger(AnkushKafkaClusterCreation.class);
	
	private ArrayList<String> cssFiles;
	private ArrayList<String> jsFiles;
	public AnkushKafkaClusterCreation() {
	...
	public String nodeDetail(ModelMap model) {
		...
		model.addAttribute("title", "oNodeDetail");
		return "kafka/kafkaClusterCreation/retrievedNodeDetail";
	}
