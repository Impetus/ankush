...
com.impetus.ankush.hadoopCluster = {
		...
		showErrorStateCluster : function(clusterId) {
			...
			com.impetus.ankush.placeAjaxCall(hadoopDetailsUrl, "GET", true, null,function(result) {
...
//			if($('#throughPassword').attr('checked'))
		...
		getCloudDetails : function(){
			...
			com.impetus.ankush.placeAjaxCall(cloudDetailsUrl, "POST", true, data,function(result) {
...
//			if($('#throughPassword').attr('checked')) {
			...
			com.impetus.ankush.placeAjaxCall(clusterCreateUrl, "POST", true, data,function(result) {
...
//			$("#downloadRadio-"+componentName).attr("checked", true);
		...
		setupDetailValuePopulate : function(currentClusterId){
			...
			+ '/details';
	    	com.impetus.ankush.placeAjaxCall(deploymentDetailUrl, "GET", true, null,function(result) {
					hadoopDeployedData_Error = result;
		...
		deleteClusterHadoop : function() {
			...
			if (currentClusterId == null) {
				...
				com.impetus.ankush.placeAjaxCall(deleteUrl, "DELETE", true, null,function(result) {
