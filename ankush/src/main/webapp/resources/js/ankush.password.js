...
com.impetus.ankush.password={
		...
		changePassword : function(){
			...
			com.impetus.ankush.placeAjaxCall(url,"POST",false,data,
					...
					function(data){
						...
						$('#errorBtn').text("1 Error").show();
						$("#popover-content").append("1. "+jsonObject.description);
						$('#error-div').show();
	...
	emptyValidation : function(fieldId){
		if(!com.impetus.ankush.validate.empty($("#"+fieldId).val())){
			...
			$("#popover-content").append('<div class="errorLineDiv"><a href="javascript:com.impetus.ankush.password.focusError(\''+ fieldId + '\');">'+com.impetus.ankush.password.errorCount + ". " + errorMsg+'</a></div>');
