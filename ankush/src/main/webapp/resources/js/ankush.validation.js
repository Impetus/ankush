...
com.impetus.ankush.validation = {
						...
						showErrorDiv : function(errorDivIdContainer, errorHeaderBtnId) {
							...
							if(com.impetus.ankush.validation.errorCount > 1)
								$('#'+errorHeaderBtnId).text(com.impetus.ankush.validation.errorCount + " Errors");
							else
								$('#'+errorHeaderBtnId).text(com.impetus.ankush.validation.errorCount + " Error");
						},
				    	...
				    	addErrorToDiv : function(fieldId, errorDivId, errorMsg, tooltipMsg) {
				    		var appendToDiv = '<div class="errorLineDiv"><a style="color: #5682C2;" href="#">' + 
				    						  errorMsg+'</a></br></div>';
				    		if(fieldId != null)
				    		{
				    			$('#'+fieldId).addClass('error-box');
				    			appendToDiv = '<div class="errorLineDiv"><a style="color: #5682C2;" href="javascript:com.impetus.ankush.validation.focusError(\''+ 
				    	...
				    	addErrorToDivJumpToAnchor : function(fieldId, errorDivId, errorMsg, tooltipMsg) {
				    		...
				    		{
				    			$('#'+fieldId).addClass('error-box');
				    			appendToDiv = '<div class="errorLineDiv"><a style="color: #5682C2;" href="javascript:com.impetus.ankush.validation.jumpToAnchor(\''+ 
											  fieldId + '\');">'+errorMsg+'</a></br></div>';	
				    			com.impetus.ankush.common.tooltipMsgChange(fieldId, tooltipMsg);
				    		}
							$("#"+errorDivId).append(appendToDiv);
						...
						addNewErrorToDivJumpToAnchor: function(fieldId, errorDivId, errorMsg, tooltipMsg) {
							com.impetus.ankush.validation.errorCount++;
				    		var errorMsgToAppend = com.impetus.ankush.validation.errorCount + ". " + errorMsg;
