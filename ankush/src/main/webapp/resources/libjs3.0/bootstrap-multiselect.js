...
!function($) {"use strict";// jshint ;_;
    ...
    Multiselect.prototype = {
        ...
        createOptionValue: function(element) {
            ...
            var $li = $("<li><a href='javascript:void(0);'><label class='" + inputType + "'><input class='headerMultipleBox' type='" + inputType + "' data-value='"+JSON.stringify(value)+"' label='"+label+"'/></label></a></li>");
