...
<script>
	...
	$("#nodeIpProgressTable_filter")
			.prepend(
					'<div style="float:left;margin-top:15px;" id="nodeIpProgressDatatable"></div><div style="float:left;margin-top:15px;display:none" id="nodeDeployCount"></div>');
		...
		<div class="container-fluid mrgnlft8">
			<div id="addNodeStop" class="box-dialog" style="display: none;">
				...
				<div class="row-fluid text-right">
					...
					<button class="btn span2" id="cancelDeleteButton">Cancel</button>
				</div>
			</div>
			<div class="row-fluid">
				<div class="span12 ">
