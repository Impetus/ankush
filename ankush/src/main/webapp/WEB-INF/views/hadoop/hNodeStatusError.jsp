...
------------------------------------------------------------------------------->
<!-- Node Details Page (Node Details ; Errors During Deployment & Logs) during Cluster Deployment Failed  -->
...
<body style="background: none;">
	...
	<div class="section-body">
		...
		<div class="row-fluid">
			...
			<div class="span9">
				<label class="text-left data" style="color: black;"
					id="NSD_nodePrivateIP"></label>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span3">
		...
		<div class="row-fluid">
			<div class="span3 ">
				<label class="text-right form-label">Rack:</label>
			</div>
			<div class="span9">
				<label class="text-left data" id="NSD_nodeRack"></label>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span3 ">
		...
		<div class="row-fluid">
			<div id="NSD_nodeErrorList" class="span12"></div>
		</div>
		<div class="row-fluid">
			<div class="span4">
				<h4 class="section-heading" style="color: black; text-align: left;">Node
