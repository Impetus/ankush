...
$(document).ready(function(){
	...
	com.impetus.ankush.hadoopMonitoring.getDefaultLogDownloadValue(clusterId);
});
</script>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			...
			<div class="span10 text-left">
				<select id="nodeType"
					onchange="com.impetus.ankush.hadoopMonitoring.fillNodeType(<c:out value='${clusterId}'/>);"
		...
		<div class="row-fluid">
			...
			<div class="span10 text-left">
				<select id="nodeIP"
					onchange="com.impetus.ankush.hadoopMonitoring.nodeIPChange(<c:out value='${clusterId}'/>);"
		...
		<div class="row-fluid">
			...
			<div class="span10 text-left">
				<select id="fileName" class="log_select" data-toggle="tooltip"
					...
					onchange="com.impetus.ankush.hadoopMonitoring.fileNameChange();"><option></option></select>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span2">
			...
			<div class="span10 text-left">
				<div class="text-left mrgt10">
					<button class="btn mrgr10" id="viewLogs"
						onclick="com.impetus.ankush.hadoopMonitoring.logDisplay(<c:out value='${clusterId}'/>)">View</button>
						<button class="btn" id="downloadLogs"
						onclick="com.impetus.ankush.hadoopMonitoring.download(<c:out value='${clusterId}'/>)">Download</button>
				</div>
