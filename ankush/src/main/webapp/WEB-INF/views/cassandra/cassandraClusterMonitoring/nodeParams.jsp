...
<script
	src="<c:out value='${baseUrl}' />/public/js/cassandra/nodeParameters.js"
	type="text/javascript"></script>
<script>
var cassandraNodeParameterTable = null;
$(document).ready(function(){
	//row grouping datatable for cassandra parameters
	cassandraNodeParameterTable=$('#cassandraNodeParameterTable').dataTable({
		"bJQueryUI" : false,
		"bPaginate" : false,
		"bLengthChange" : true,
		"bFilter" : false,
...
<div class="row-fluid" style="margin-top: 20px;">
		<div class="span7">
			<h2 class="heading text-left left">Node Parameters</h2>
		...
		<div class="span5 text-right">
			...
			<button class="btn" id="applyParameters" data-loading-text="Applying..."
				onclick="com.impetus.ankush.nodeParameters.applyChangesPostParamObj();"
				>Apply</button>
		</div>
</div>
</div>
...
<div class="row-fluid">
		<div class="span3 text-left mrgt20">
			<button class="btn" id="addNodeParameters"
				onclick="com.impetus.ankush.nodeParameters.addParamDialog();"
				style="margin-right: 50px;">Add Parameter</button>
		</div>
	</div>
			...
			<div class="modal-body" style="overflow : hidden;">
				<div class="row-fluid">
					...
					<div class="span6 text-left" style="margin-left: 23px">
						<select id="fileNameValueAddNodeParam" data-placement="right"></select>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span4">
	...
	<div class="row-fluid mrgt10">
		<div class="span12 text-left">
			<table class="table table-striped" id="cassandraNodeParameterTable"
