...
<script src="<c:out value='${baseUrl}' />/public/js3.0/commonMonitoring/nodeDrillDown.js" type="text/javascript"></script>
<script>
var hostName = '';
	...
	<div class="page-wrapper">
		...
		<%@ include file="../layout/breadcrumbs.jsp"%>
			<div class="container-fluid">
				...
				<div class="row" id="common-section">
					...
					<div class="panel">
								...
								<div class="btn-group" id="graphButtonGroup_JobMonitoring"
									...
									<a href="#" class="btn btn-default btn-sm active" id="btnLastYear_HNDD" onclick="com.impetus.ankush.nodeDrillDown.drawGraph_JobMonitoring('lastyear','<c:out value ='${hostName}'/>');">1 y</a>
            						<a href="#" class="btn btn-default btn-sm" id="btnLastMonth_HNDD"onclick="com.impetus.ankush.nodeDrillDown.drawGraph_JobMonitoring('lastmonth','<c:out value ='${hostName}'/>');">1 m</a>
            						<a href="#" class="btn btn-default btn-sm" id="btnLastWeek_HNDD"onclick="com.impetus.ankush.nodeDrillDown.drawGraph_JobMonitoring('lastweek','<c:out value ='${hostName}'/>');">1 w</a>
            						<a href="#" class="btn btn-default btn-sm" id="btnLastDay_HNDD"onclick="com.impetus.ankush.nodeDrillDown.drawGraph_JobMonitoring('lastday','<c:out value ='${hostName}'/>');">1 d</a>	
									<a href="#" class="btn btn-default btn-sm" id="btnLastHour_HNDD"onclick="com.impetus.ankush.nodeDrillDown.drawGraph_JobMonitoring('lasthour','<c:out value ='${hostName}'/>');">1 h</a>
								</div>
									<a href="<c:out value='${baseUrl}'/>/commonMonitoring/<c:out value='${clusterName}'/>/nodeDetails/nodeUtilizationTrend/C-D/<c:out value='${clusterId}'/>/<c:out value='${clusterTechnology}'/>/<c:out value='${hostName}'/>" class="fa fa-chevron-right mrgl10 pull-right mrgt5 mrgr10" style="font-size: 16px;"></a>
				...
				<!-- <div id="div_RequestSuccess_NodeServices" class="modal hide fade"
					style="display: none;">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-md-12" style="text-align: left; font-size: 14px;" id="service-message"></div>
						</div>
					</div>
					<br>
				...
				<div class="modal fade" id="div_RequestSuccess_NodeServices" tabindex="-1"
